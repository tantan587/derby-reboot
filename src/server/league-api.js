...
router.get("/nba", (req, res) =>
    {
        knex.select('nba_info.team_id', 'nba_info.key', 'nba_info.city', 'nba_info.name', 'nba_standings.wins', 'nba_standings.losses')
        .from('nba_info')
        .innerJoin('nba_standings', 'nba_info.team_id', 'nba_standings.team_id')
